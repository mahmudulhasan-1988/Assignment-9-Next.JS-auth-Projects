...
const SuccessStories = () => {
  ...
  return (
    ...
    <section className="relative overflow-hidden bg-gradient-to-b from-[#fff7fb] to-[#fdfdfd] py-24 px-5">
      ...
      {/* BLUR EFFECT */}
      <div className="absolute top-20 left-20 w-72 h-72 bg-pink-200 blur-3xl opacity-30 rounded-full"></div>

      <div className="absolute bottom-20 right-20 w-72 h-72 bg-cyan-200 blur-3xl opacity-30 rounded-full"></div>
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center max-w-4xl mx-auto">
          ...
          {/* BADGE */}
          <div className="inline-flex items-center gap-2 bg-white border border-pink-200 text-pink-500 px-5 py-2 rounded-full mb-6 shadow-md">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-20">
          ...
          {successStories.map((story) => (
            ...
            >
              ...
              {/* QUOTE */}
              <p className="text-gray-600 italic leading-9 text-lg">
