...
const PetCareGuide = () => {
  ...
  return (
    ...
    <section className="relative overflow-hidden bg-gradient-to-b from-[#fff7fb] via-[#ffffff] to-[#fdfdfd] dark:from-[#09142b] dark:via-[#0f172a] dark:to-[#111827] py-24 px-5 transition-all duration-500">
      ...
      {/* BLUR EFFECTS */}
      <div className="absolute top-10 left-10 w-72 h-72 bg-pink-200 dark:bg-pink-900 blur-3xl opacity-30 rounded-full"></div>

      <div className="absolute bottom-10 right-10 w-72 h-72 bg-cyan-200 dark:bg-cyan-900 blur-3xl opacity-30 rounded-full"></div>
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center max-w-4xl mx-auto">
          ...
          {/* BADGE */}
          <div className="inline-flex items-center gap-2 bg-white dark:bg-[#1e293b] border border-pink-200 dark:border-pink-800 text-pink-500 px-5 py-2 rounded-full shadow-md mb-6">
          ...
          {/* TITLE */}
          <h1 className="text-5xl md:text-7xl font-extrabold leading-tight text-[#0f172a] dark:text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-20">
          ...
          {petCareTips.map((tip) => (
            ...
            <div
              key={tip.id}
              className="bg-white/90 dark:bg-[#1e293b]/90 backdrop-blur-xl border border-pink-100 dark:border-[#334155] rounded-[30px] p-8 shadow-xl hover:-translate-y-3 hover:shadow-2xl transition-all duration-500"
            >
              ...
              <div className="flex items-start gap-5">
                ...
                {/* ICON */}
                <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-pink-100 to-cyan-100 dark:from-pink-900 dark:to-cyan-900 flex items-center justify-center text-3xl shadow-md shrink-0">
