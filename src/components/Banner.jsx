...
const Banner = () => {
  ...
  return (
    ...
    <section className="relative overflow-hidden bg-[#fff7f5] dark:bg-[#09142b] transition-all duration-300">

      {/* BACKGROUND ANIMATION */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">

        <FaPaw className="absolute top-10 left-10 text-pink-200 dark:text-pink-900 text-7xl animate-bounce" />

        <FaPaw className="absolute top-32 right-20 text-orange-200 dark:text-orange-900 text-6xl animate-pulse" />

        <FaPaw className="absolute bottom-20 left-1/4 text-cyan-200 dark:text-cyan-900 text-8xl animate-ping opacity-40" />

        <FaDog className="absolute top-1/3 left-20 text-pink-300 dark:text-pink-800 text-8xl animate-pulse opacity-20" />

        <FaCat className="absolute top-20 right-1/3 text-purple-200 dark:text-purple-800 text-7xl animate-bounce opacity-20" />

        <FaDog className="absolute bottom-10 right-10 text-rose-200 dark:text-rose-800 text-7xl animate-bounce opacity-20" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-20 lg:py-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-16">
          ...
          >
            ...
            {/* TITLE */}
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-extrabold leading-tight text-black dark:text-white transition-all duration-300">
            ...
            {/* DESCRIPTION */}
            <p className="mt-8 text-lg text-gray-600 dark:text-gray-300 leading-8 max-w-xl transition-all duration-300">
          ...
          >
            ...
            {/* FLOATING CARD 1 */}
            <div className="absolute top-10 left-0 bg-white dark:bg-[#16233f] shadow-2xl rounded-2xl px-5 py-4 animate-bounce transition-all duration-300">
            ...
            {/* FLOATING CARD 2 */}
            <div className="absolute bottom-10 right-0 bg-white dark:bg-[#16233f] shadow-2xl rounded-2xl px-5 py-4 animate-pulse transition-all duration-300">
...
//   return (
//     <section className="relative overflow-hidden bg-[#fff7f5] dark:bg-[#09142b] text-black dark:text-white  p-10">
